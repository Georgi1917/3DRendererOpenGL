...
LDFLAGS = -Llib -lglfw3 -lglew32 -lgdi32 -lopengl32 -lassimp -lz
...
RENDERABLES_OBJS = Renderables/Renderable.cpp Renderables/Cube.cpp Renderables/Sphere.cpp Renderables/LightSource.cpp Renderables/Surface.cpp
MODELS = Models_c/Mesh.cpp
...
SRC = main.cpp stb_image.cpp $(IMGUI) $(ADDITIONAL_OBJS) $(RENDERABLES_OBJS) $(MODELS) $(FRAMEBUFFER_OBJS) $(TEXTURES)
