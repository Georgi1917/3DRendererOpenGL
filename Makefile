...
IMGUIZMO = include/imguizmo/ImGuizmo.cpp
...
SRC = main.cpp stb_image.cpp tiny_obj_loader.cpp $(IMGUI) $(IMGUIZMO) $(RENDERER) $(ADDITIONAL_OBJS) $(SCENE) $(FRAMEBUFFER_OBJS) $(TEXTURES) $(WINDOW)
